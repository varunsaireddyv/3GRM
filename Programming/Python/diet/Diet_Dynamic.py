...
if LoginSignupQuestion == 'sign up':
    ...
    cursor.execute("INSERT INTO UserDataDiet VALUES (:first, :last, :mail)", {'first': first_name, 'last': last_name, 'mail': mail})
    connection.commit()
    print('your sign up has been completed please awnser this questions in order to customize your menu')
    user_health_history=input('please enter any medical illness or any accidents in past one year')
